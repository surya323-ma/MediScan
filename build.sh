...
if Doctor.objects.count() == 0:
    doctors = [
        ...
        dict(name='Vikram Joshi', specialty='Gastroenterologist', experience=9, rating=4.5, fee=550, available_today=True, location='Govind Nagar, Kanpur', diseases='hepatitis,jaundice,gastroenteritis,typhoid', avatar_initials='VJ', avatar_color='blue'),
        ...
        dict(name='Meena Dixit', specialty='General Physician', experience=6, rating=4.4, fee=300, available_today=True, location='Shyam Nagar, Kanpur', diseases='malaria,dengue,common cold,influenza,gastroenteritis', avatar_initials='MD', avatar_color='green'),
